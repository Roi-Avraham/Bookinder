...
class RegisterActivity : AppCompatActivity() {
    ...
    private fun createAccount() {
        ...
        val phone_number = signup_phone_number.text.toString()
        ...
        when{
            ...
            TextUtils.isEmpty(phone_number)-> Toast.makeText(this, "Phone number is required", Toast.LENGTH_SHORT).show()
            !password.equals(confirm_password) -> Toast.makeText(this, "Confirm password is not correct", Toast.LENGTH_SHORT).show()
            !PhoneNumberUtils.isGlobalPhoneNumber(phone_number) -> Toast.makeText(this, "Phone number is not valid", Toast.LENGTH_SHORT).show()
            ...
            else->
            {
                ...
                mAuth.createUserWithEmailAndPassword(email,password)
                        .addOnCompleteListener { task ->
                            ...
                            {
                                saveUserInfo(fullName,phone_number,email,progressDialog)
                                progressDialog.dismiss()
                                val intent=Intent(this@RegisterActivity,ProfileExpansion::class.java)
    ...
    private fun saveUserInfo(fullName: String, phone_number: String, email: String,progressDialog:ProgressDialog) {
        ...
        userMap["phone_number"]=phone_number
        userMap["email"]=email
