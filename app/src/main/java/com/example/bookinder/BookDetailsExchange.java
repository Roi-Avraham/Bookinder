...
public class BookDetailsExchange extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.book_detail_exchange);
        getIncomingIntent();
    }
    private void getIncomingIntent(){
        String book_name = getIntent().getStringExtra("book_name");
        //int book_image = getIntent().getIntExtra("book_image",0);
        ...
        //int ownerImage = getIntent().getIntExtra("ownerImage",0);
        ...
        setDetails(book_name,book_image, author_name,genre,ownerImage,ownerName);
        ...
        name_of_user.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(CurrentUser.currentUser.equals(ownerId)) {
                    Intent intent = new Intent(BookDetailsExchange.this, MyProfileActivity.class);
                    startActivity(intent);
                } else {
                    Intent intent = new Intent(BookDetailsExchange.this, TestActivity.class);
    ...
    private void setDetails(String book_name,String book_image, String author_name,String genre,
                            String ownerImage,String ownerName) {
