package com.example.bookinder.Profile.ui.slideshow;
...
import com.example.bookinder.databinding.FragmentSlideshowBinding;
...
public class SlideshowFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        try {
            bookForSaleForm.put("current_user", ownerId);
        ...
        postRequest(ServerAddress.serverAddress+"/items/exchange/" + ownerId, body);
